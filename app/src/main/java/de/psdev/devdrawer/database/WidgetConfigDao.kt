...
abstract class WidgetConfigDao {
    ...
    fun updateWidget(id: Int, name: String, widgetId: Int): Disposable {
        return Completable.fromAction { update(WidgetConfig(id, name, widgetId)) }.subscribeOn(Schedulers.io()).subscribe()
    }
}
